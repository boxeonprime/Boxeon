...
@section('title', 'Boxeon.com Honey Beans Porridge')
...
@section('content')
    <main>
        <section id="blogs-stream" class='section maxw1035 two-col-grid rounded-corner card'>
            ...
            <div>
                <h1 class="blog-title font-size-3-em">Honey Beans Porridge</h1>
                <img class="w100per margin-bottom-2-em" src="../assets/images/products/honey.jpeg">
                ...
                <h2>3. What meats goes with Honey Beans Porridge?</h2>
                <p>Honey Beans Porridgegoes well with chicken, turkey, other white meats, and Tofu. Slices of Agege
            ...
            <section>
                <div class="nutrition-col">
                    <h2 class="nutrition-col__nutritionalFacts-title">Honey Beans Nutrients </h2>
