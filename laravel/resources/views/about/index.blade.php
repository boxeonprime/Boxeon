        ...
        <section id="banner" class="section wide bg-color-yellow">
            ...
            <div class="m-hide card white">
                <h1 class="text-3em">We started Boxeon to make it simple for the diaspora to enjoy the foods they love from
                    ...
                    management and stress; if you've ever worried about the rampant carcinogenics in Western foods; if
                    you've ever wished to experience more of your home culture; we're here for you.</h1>
                <h1 class="text-3em">We're here for anyone and everyone who wants to consume from back home but whose time
                    is valuable.</h1>
                <h1 class="text-3em"> We're a service for diasporans with busy lives to automate and repatriate their
                    grocery shopping.</h1>
                <h1 class="text-3em">We believe that a culture of "work abroad, but consume from home" will one day spark
                    industrial revolutions in our home countries. That's what Boxeon is about.</h1>
            </div>
            <section class='m-hide section maxw1035 rounded-corner card'>
                    ...
                    <div id="orgs" class="three-col-grid">
                        <div>
                            ...
                            <p class="centered">Young girls in Minna, Nigeria, have limited access to science, technology,
                                engineering, and mathematics (STEM) material. STEM Camp for Girls provides them with these
                                resources
                        ...
                        <div>
                            ...
                            <p class="centered">Women's Tech Empowerment Centre focuses on fostering Nigeria's next
                                generation
                                of female technology creators, entrepreneurs, and leaders. Your monthly Boxeon subscription
                                will
                        ...
                        <div>
                            ...
                            <p class="centered">Tabitha Home's mission is to rehabilitate and transform former disadvantaged
                                youth so they may live fulfilled lives. Your monthly Boxeon subscription will significantly
                                support
                                this charity.</p>
                        </div>
                    </div>
                ...
                <div class="alert-info">
                    <p><span class="material-icons text-red">info</span>&nbsp;Our subscribers receive a Christmas gift card
                        from
                ...
                <p> Set up regularly scheduled deliveries and earn savings. We'll ship your African groceries to you
                    nationwide so; you no longer have to go hunting for them. You may cancel or pause a delivery at any
                    time.</p>
                ...
                <ol>
                    ...
                    <li>Skip your deliveries or cancel your subscriptions at any time by signing in, clicking on your user
                        icon and then clicking on Subscriptions.</li>
                    <li>In advance of each delivery, we will send you a reminder email showing the item price and any
                        applicable
                ...
                <ol>
                    ...
                    <li>At the top of the page you will see three tabs: Deliveries, Subscriptions, and Settings. Click on
                        the
                        Settings tab.</li>
                ...
                <ol>
                    ...
                    <li>To change your payment method for all subscriptions, click on the Settings tab. Then click Change
                        under
                        Payment Method.</li>
                ...
                <p>While you will always receive a Boxeon discount, individual product prices can go up or down over
                    time. If the price of your subscribed product changes, the new price will be displayed in your order
                    review
            ...
            <div class="pitch w100per margin-bottom-4-em">
                <div class="maxw800px margin-auto centered padding-2-per">
                    <h1 class="text-3em">We started Boxeon to make it simple for the diaspora to enjoy the foods they love
                        from home. But we quickly learned that Boxeon is much more than that. If you've ever had problems
                        with time management and stress; if you've ever worried about the rampant carcinogenics in Western
                        foods; if you've ever wished to experience more of your home culture; we're here for you.</h1>
                    <h1 class="text-3em">We're here for anyone and everyone who wants to consume from back home but whose
                        time is valuable.</h1>
                    <h1 class="text-3em"> We're a service for diasporans with busy lives to automate and repatriate their
                        grocery shopping.</h1>
                    <h1 class="text-3em">We believe that a culture of "work abroad, but consume from home" will one day
                        spark industrial revolutions in our home countries. That's what Boxeon is about.</h1>
                </div>
            </div>
            <section class="section wide margin-bottom-4-em bg-yellow">
                ...
                <div class="four-col-grid">
                    ...
                    <div>
                        <p>We’re committed to lifting up and celebrating women in business to honor their accomplishments.
                            ...
                            community to shop with their values while finding products that suit their needs. We engage in
                            opportunities to speak to and mentor women in all stages and types of careers. We partner with
                            women-founded, owned, owned and run companies and non-profits with women-centered missions.</p>
                    </div>
                    <span></span>
                </div>
                <div class="four-col-grid">
