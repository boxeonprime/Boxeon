        ...
        <section id="blogs-stream" class='section maxw1035 two-col-grid rounded-corner card'>
            ...
            <div>
                ...
                <div>
                    ...
                    <img class="w100per margin-bottom-2-em" src="../assets/images/products/sobo.webp" alt="Hibiscus Flowers Tea">
                    ...
                    <ul>
                        <li>
                        <li>400g Dried Hibiscus Leaves</li>

                        <li>1 Very Ripe and Sweet Pineapple</li>

                        <li>2 Sweet Oranges</li>

                        <li>2 Inch Ginger Root</li>

                        <li>1 Cup Pure Honey</li>

                        <li>2 Tablespoons Cloves (Konofuru/Konofiri)</li>

                        <li>Cinnamon Stick</li>

                        </li>
                    </ul>
                    <h2 class="primary-color  extra-large-font">Instructions</h2>
                    <ul>
                        <li>See video for instructions.</li>
                    </ul>
                    ...
                    <div id="video">
                        <iframe width="560" height="315" loading="lazy" src="https://www.youtube.com/embed/nTrUcAU5JUA"
            ...
            <section>
                <div class="nutrition-col">
                    <h2 class="nutrition-col__nutritionalFacts-title">Sobo Nutritional Info </h2>
