    ...
    <main>
        <section class='section maxw1035 rounded-corner card'>
                ...
                <div>
                    ...
                    <ul>
                        <li>
                        <li><a href="/shop/item?id=41" class="one-em-font primary-color underline">4 -14.5 ounce canned beans or 1 pound dried beans</a></li>
                        <li><a href="/shop/item?id=36" class="one-em-font primary-color underline">1/2 - 3/4 cup palm oil</a></li>
                        <li>1 medium onion</li>
                        <li>2 Tomatoes</li>
                        <li><a href="/shop/item?id=53" class="one-em-font primary-color underline">1 tablespoon bouillon powder</a></li>
